...
encoder_path = 'fraud_encoder_deep.hdf5'
decoder_path = 'fraud_decoder_deep.hdf5'
autoencoder_path = 'fraud_autoencoder_deep.hdf5'
model_graph_path = 'fraud_autoencoder_deep_graph.png'
...
intermediate = Dense(intermediate_dim, activation='swish', activity_regularizer=my_regularizer)(input_x)

# "encoded" is the encoded representation of the inputs
encoded = Dense(encoding_dim, activation='swish', activity_regularizer=my_regularizer)(intermediate)
...
intermediate = Dense(intermediate_dim, activation='swish', activity_regularizer=my_regularizer)(encoded)
